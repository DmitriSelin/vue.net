...
// Inject minimal default styles (optional, but prevents layout shift).
...
export const init = (selector: string = '[data-vue-component]'): void => {
  injectBaseStyles();
...
export const destroy = (selector: string = '[data-vue-component]'): void => {
